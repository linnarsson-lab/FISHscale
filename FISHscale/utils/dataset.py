...
class Dataset(Regionalize, Iteration, ManyColors, GeneCorr, GeneScatter, AttributeScatter, SpatialMetrics, DataLoader, Normalization, 
    ...
    def segment(self,
        ...
        def segmentation(partition):
            ...
            segmenter = QTClustering(max_radius=20, metric='euclidean', min_cluster_size=10, verbose=False)
        ...
        np.save(path.join(save_to,self.filename.split('.')[0]+'_polygons.loom'),polygons)
