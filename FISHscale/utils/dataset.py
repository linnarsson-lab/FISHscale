...
def segmentation(partition, func):
            ...
            #    data
            results_resegmentation = Parallel(n_jobs=multiprocessing.cpu_count(), backend='multiprocessing')(delayed(resegmentation)(part) for _, part in partition.groupby('tmp_sement'))
            resegmentation = []
            count = 0
